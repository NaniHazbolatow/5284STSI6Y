...
In the first assignment, we have used Monte Carlo simulation to estimate the area of the Mandelbrot Set using different sampling techniques. Go to the [Assignment 1](https://github.com/NaniHazbolatow/5284STSI6Y/tree/main/Assignment%201) folder for further information
